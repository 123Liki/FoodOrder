                        ...
                        <li>
                            <div className="food-item">
                                ...
                                <div className="food-item-details">
                                    ...
                                    <button
                                        onClick={() =>
                                            handleFoodSelect({ id: 1, name: 'Burger', price: 80, image: require('./burger.jpg') })
                                        }
                                    >
                                        Add to Order
                                    </button>
                        ...
                        <li>
                            <div className="food-item">
                                ...
                                <div className="food-item-details">
                                    ...
                                    <button
                                        onClick={() =>
                                            handleFoodSelect({ id: 2, name: 'Pizza', price: 150, image: require('./pizza.jpg') })
                                        }
                                    >
                                        Add to Order
                                    </button>
                        ...
                        <li>
                            <div className="food-item">
                                ...
                                <div className="food-item-details">
                                    ...
                                    <button
                                        onClick={() =>
                                            handleFoodSelect({ id: 3, name: 'Pasta', price: 120, image: require('./pasta.jpg') })
                                        }
                                    >
                                        Add to Order
                                    </button>
                        ...
                        <li>
                            <div className="food-item">
                                ...
                                <div className="food-item-details">
                                    ...
                                    <button
                                        onClick={() =>
                                            handleFoodSelect({ id: 4, name: 'Noodles', price: 90, image: require('./noodles.jpg') })
                                        }
                                    >
                                        Add to Order
                                    </button>
